...
for (tweet of tweets){
  ...
  if(tweetid)
      res[doi].push(tweetid);
}
console.log(res)
  }
  }
  /*  await driver.get("https://plu.mx/plum/a/blog?doi=https://doi.org/10.1007/s12064-020-00320-8"),
    await driver.wait(() => documentInitialised(), 10000);
  await sleep(5000);
let blogs= await driver.findElements(By.xpath("//div[@class='card panel panel-s artifact-reference-item blog-reference-item']"));
console.log(blogs)
*/
