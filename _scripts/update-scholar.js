...
const WEBMENTION_CACHE = '_cache/scholar.json';
...
const updateWebmention = async function () {
 /* 
 scholarly.user("5eOo9hQAAAAJ").then((data) => {
  console.log(data);
});*/
  scholarly.search("author:Maël author:Montévil").then((data) => {
  console.log(data);
});

    writeToCache(scholarly.user("5eOo9hQAAAAJ"), WEBMENTION_CACHE);
